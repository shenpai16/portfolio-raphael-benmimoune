                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mx-auto w-full max-w-6xl px-4">
                    ...
                    <Card className="min-w-[280px] md:min-w-[320px] min-h-[420px]">
                        <CardContent className="flex flex-col justify-between h-full">
                            <h3 className="text-2xl font-semibold text-center">Site Vitrine Essentiel</h3>
                            <p className="text-center text-sm test-gray-300">
                            ...
                            <p className="text-center text-lg font-semibold text-blue-400 mt-4">à partir de 800€</p>
                    ...
                    <Card className="min-w-[280px] md:min-w-[320px] min-h-[420px]">
                        <CardContent className="flex flex-col justify-between h-full">
                            <h3 className="text-2xl font-semibold text-center">Site Pro & Back-office</h3>
                            <p className="text-center text-sm test-gray-300">
                            ...
                            <p className="text-center text-lg font-semibold text-blue-400 mt-4">à partir de 1500€</p>
                    ...
                    <Card className="min-w-[280px] md:min-w-[320px] min-h-[420px]">
                        <CardContent className="flex flex-col justify-between h-full">
                            <h3 className="text-2xl font-semibold text-center">Site 100% Sur-Mesure</h3>
                            <p className="text-center text-sm test-gray-300">
                            ...
                            <p className="text-center text-lg font-semibold text-blue-400 mt-4">sur devis.</p>
                       
                        </CardContent>
                    </Card>
                </div>
                <div className="text-white mt-48 text-center max-w-6xl mx-auto px-16">
                    <h3 className="text-3xl font-bold mb-4">Pourquoi me faire confiance ?</h3>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-6 text-sm text-gray-300">
                        <div>
